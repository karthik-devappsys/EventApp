...
namespace EventManageApp.Migrations
{
    ...
    [Migration("20241106113939_create-event-and-bookings")]
    partial class createeventandbookings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EventManageApp.Data.Entities.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Contact = "1234567890",
                            CreatedAt = new DateTime(2024, 11, 6, 11, 39, 38, 417, DateTimeKind.Utc).AddTicks(2156),
                            Email = "admin@exmaple.com",
                            Name = "Admin",
                            Password = "$2a$10$IJUiOnTMGvKNGUt2JnqjAuiAZHPDAj5e5RrGqCk.QyiC4d3CgBiYO",
                            Status = "Active",
                            UserType = "Admin"
                        });
                });
